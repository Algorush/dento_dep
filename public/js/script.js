...
/* harmony export */ });
/* harmony import */ var _getToken__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getToken */ "./js/libs/getToken.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var Filter = /*#__PURE__*/function () {
  ...
  function Filter(data) {
    ...
    var TOKEN = (0,_getToken__WEBPACK_IMPORTED_MODULE_0__.getToken)();
  ...
  _createClass(Filter, [{
    ...
    key: "initCLickOnFilterParams",
    value: function initCLickOnFilterParams() {
      var _this = this;
      $('body').on('click', this.paramFilterInput, function () {
        var $el = $(this).closest(_this.filterParamsClass);
        var value = $(this).val();
        var stateAttr = $el.data('name');
    ...
    key: "initShowMoreClick",
    value: function initShowMoreClick() {
      var _this = this;
    ...
    key: "initSortingOnChange",
    value: function initSortingOnChange() {
      var _this = this;
    ...
    key: "initSendRequestBtn",
    value: function initSendRequestBtn() {
      var _this = this;
      $('body').on('click', this.classSendRequest, function (event) {
    ...
    key: "changeFilterState",
    value: function changeFilterState(val, attrName) {
      var stateAttr = this.state[attrName];
      if (_typeof(stateAttr) !== 'object') {
        stateAttr = val;
        return;
      }
      if (!stateAttr.length) {
      ...
      var res = stateAttr.findIndex(function (el) {
        return el == val;
      });
      if (res != -1) {
    ...
    key: "appendItems",
    value: function appendItems(newItems) {
    ...
    value: function changeCount() {
      var count = $(this.findedCount).html();
    ...
    key: "createFilterParams",
    value: function createFilterParams() {
      var _this2 = this;
      $(this.filterParamsClass).each(function (i, el) {
        var paramName = $(el).data('name');
        var type = $(el).data('type');
        if (paramName && !type) {
          _this2.state[paramName] = [];
          return;
        }
        _this2.state[paramName] = '';
      });
    ...
    value: function request() {
      var _this3 = this;
      var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.requestUrl;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AjaxPopup": function() { return /* binding */ AjaxPopup; }
/* harmony export */ });
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./popup */ "./js/libs/popup/popup.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var AjaxPopup = /*#__PURE__*/function (_Popup) {
  _inherits(AjaxPopup, _Popup);
  var _super = _createSuper(AjaxPopup);
  function AjaxPopup() {
    _classCallCheck(this, AjaxPopup);
    return _super.apply(this, arguments);
  }
  _createClass(AjaxPopup, [{
    key: "openPopup",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MagicPopup": function() { return /* binding */ MagicPopup; }
/* harmony export */ });
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./popup */ "./js/libs/popup/popup.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var MagicPopup = /*#__PURE__*/function (_Popup) {
  _inherits(MagicPopup, _Popup);
  var _super = _createSuper(MagicPopup);
  /**
   * @param openClass
   * @param closeClass
   * @param data
   */
  function MagicPopup(openClass, closeClass) {
    var _this;
    var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    _classCallCheck(this, MagicPopup);
    _this = _super.call(this, openClass, closeClass);
    data = Object.assign(defaultSettings, data);
    //popup class
    _this.popupClass = data.popupClass;
    //bg class
    _this.bgId = data.bgId;
    // Node for popup
    _this.popup = $("<div class=\"".concat(_this.popupClass, "\"></div>"));
    //Node for background
    _this.bg = $("<div id=\"".concat(_this.bgId, "\"></div>"));
    _this.initMagicPopup();
    return _this;
  }
  _createClass(MagicPopup, [{
    key: "initMagicPopup",
    value: function initMagicPopup() {
      var _this2 = this;
      // Close on bg
      $('body').on('click', "#".concat(this.bgId), function (e) {
        _this2.closePopup();
      })
      // Close on modal which does not exist modal window
      .on('click', ".".concat(this.popupClass), function (e) {
        if ($(e.target).hasClass(_this2.popupClass)) {
          _this2.closePopup();
        }
      });
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MfPopup": function() { return /* binding */ MfPopup; }
/* harmony export */ });
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./popup */ "./js/libs/popup/popup.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var MfPopup = /*#__PURE__*/function (_Popup) {
  _inherits(MfPopup, _Popup);
  var _super = _createSuper(MfPopup);
  function MfPopup() {
    _classCallCheck(this, MfPopup);
    return _super.apply(this, arguments);
  }
  _createClass(MfPopup, [{
    key: "openPopup",
    value: function openPopup() {
      $.magnificPopup.open({
        showCloseBtn: false,
...
var Popup = /*#__PURE__*/function (_Component) {
  ...
  function Popup(callClass, closeClass) {
    ...
    _this2 = _super.call(this, callClass);
    // check on parent errors
    if (_this2.errors) return _possibleConstructorReturn(_this2);
  ...
  _createClass(Popup, [{
    ...
    value: function pushData() {
      ...
      if (typeof arr[0] === 'string') {
        form.append("<input type=\"hidden\" name=\"".concat(arr[0], "\" value=\"").concat(arr[1], "\">"));
        return;
      }
      arr.forEach(function (el) {
        console.log(el);
        form.append("<input type=\"hidden\" name=\"".concat(el[0], "\" value=\"").concat(el[1], "\">"));
      });
    }
    ...
    value: function validateData(str) {
      if (typeof str !== 'string') {
        console.warn(" Warning in Popup ".concat(this.identificator, ":the value ").concat(str, " should be string "));
        return false;
      }
      if (str.indexOf(':') < 0) {
        console.warn(" Warning in Popup ".concat(this.identificator, ":the value ").concat(str, " should contain \":\""));
        return false;
      }
      return true;
    }
    ...
    value: function checkOnExistPopupElements() {
      if (this.checkOnExistElement(this.closeClass)) {
        console.warn("on ".concat(this.identificator, " wrong close class element ").concat(this.closeClass));
      }
      if (!this.checkOnExistElement(this.popupId)) {
        console.warn("on ".concat(this.identificator, " do not set or wrong set data-popup or data-url"));
      }
    }
  }]);
  return Popup;
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function prepareFiles(inputsWithFile, data) {
      var _this8 = this;
      //console.log(inputsWithFile, data)
      var inputFiles = document.getElementsByClassName("upper_files_files_names");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Sendform": function() { return /* reexport safe */ _form__WEBPACK_IMPORTED_MODULE_0__["default"]; }
/* harmony export */ });
...
/* harmony export */ });
/* harmony import */ var _node_modules_owl_carousel_dist_owl_carousel_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/owl.carousel/dist/owl.carousel.min */ "./node_modules/owl.carousel/dist/owl.carousel.min.js");
/* harmony import */ var _node_modules_owl_carousel_dist_owl_carousel_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_owl_carousel_dist_owl_carousel_min__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _libs_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/slider */ "./js/libs/slider.js");
/* harmony import */ var _libs_sendform_sendform2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/sendform/sendform2 */ "./js/libs/sendform/sendform2.js");
/* harmony import */ var _libs_popup_mfpopup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/popup/mfpopup */ "./js/libs/popup/mfpopup.js");
/* harmony import */ var _libs_popup_ajaxPopup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/popup/ajaxPopup */ "./js/libs/popup/ajaxPopup.js");
/* harmony import */ var _libs_popup_magicPopup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../libs/popup/magicPopup */ "./js/libs/popup/magicPopup.js");
/* harmony import */ var _libs_filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../libs/filter */ "./js/libs/filter.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
$(document).ready(function () {
  ...
  var projectApp = new App();
  __webpack_require__.g.app = projectApp;
  projectApp.init();
});
