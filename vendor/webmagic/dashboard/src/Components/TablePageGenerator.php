...
class TablePageGenerator extends TableGenerator implements Renderable
{
     ...
     * Get content of page
     *
     * (it is needed in order to return the content of the entire page,
     * regardless of whether it is an asynchronous request or a regular one)
     *
     * @return string
     */
    public function renderNative(): string
    {
        return $this->getPage()->render();
    }
}
