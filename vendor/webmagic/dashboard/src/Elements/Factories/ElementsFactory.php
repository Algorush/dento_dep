...
use Webmagic\Dashboard\Elements\PaginatorSimple;
 ...
 * @method \Webmagic\Dashboard\Elements\Forms\Elements\FlexibleDateTimePicker flexibleDateTimePicker($elementAttribute = null)
 ...
 * @method \Webmagic\Dashboard\Elements\Forms\Elements\DateRange dateRange($elementAttribute = null)
 ...
 * @method \Webmagic\Dashboard\Elements\PaginatorSimple paginatorSimple($elementAttribute = null)
...
class ElementsFactory implements ElementsRegisterAbleContract
{
    ...
    protected $elements = [
        ...
        'flexibleDateTimePicker' => FlexibleDateTimePicker::class,
        ...
        'paginatorSimple' => PaginatorSimple::class,
