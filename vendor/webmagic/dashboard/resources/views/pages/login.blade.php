    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                @if($register_link)<a href="{{$register_link}}">Register a new membership</a><br>@endif
                @if($forgot_password_link)<a href="{{$forgot_password_link}}" class="text-center">I forgot my password</a>@endif
            </div>
            <!-- /.login-box-body -->
        </div>
    </div>
